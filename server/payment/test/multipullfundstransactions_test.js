...
// path invoked is '/visadirect/fundstransfer/v1/multipullfundstransactions/{statusIdentifier}';
funds_transfer_api.multipullfundstransactions(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is multipullfundstransactions ---------------');
        console.log('\n\n');
    })
