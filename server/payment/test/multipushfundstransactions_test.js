...
// path invoked is '/visadirect/fundstransfer/v1/multipushfundstransactions/{statusIdentifier}';
funds_transfer_api.multipushfundstransactions(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is multipushfundstransactions ---------------');
        console.log('\n\n');
    })
