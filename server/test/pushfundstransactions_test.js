...
// path invoked is '/visadirect/fundstransfer/v1/pushfundstransactions/{statusIdentifier}';
funds_transfer_api.pushfundstransactions(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is pushfundstransactions ---------------');
        console.log('\n\n');
    })
